...
<div class="merci">
	...
	<div class="formulaire">
		...
		<p>Mon article</p>
		<p class="clearfix"><label for="titre">TITRE <span style="color:red">*</span></label> <input type="text" name="firstname" required><br></p>
		<p class="clearfix">
	 	<label for="convienta">CONVIENT A...</label>
			<select name="convienta" id="convienta" required>
		...
		<p class="clearfix">
	 	<label for="taille">Taille</label>
			<select name="taille" id="taille">
				...
				<option value="">Pas de taille</option>
			</select>
	 	</p>
	 	<p class="clearfix">
	 	...
	 	<p class="clearfix">
	 		<button name="valider" id="boutonvalider">VALIDER</button>
	 	</p>
